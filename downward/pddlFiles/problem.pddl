(define (problem music_piece)
  ...
  (:goal
    (and
      (note-placed B4) (note-placed C5) (note-placed A5) (note-placed E4) (note-placed F4) (note-placed G5) (note-placed G4) (note-placed F5) (note-placed A4) (note-placed E5) (note-placed D5)
    )
  )
)
